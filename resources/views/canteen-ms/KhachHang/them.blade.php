    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-lg-7" style="padding-bottom:120px">
                <form action="{{url("canteen-ms/khachhang/them")}}" method="post">
                    @csrf
                    <div class="form-group">
                        <label>Tên Khách Hàng</label>
                        <input class="form-control" type="text" name="HoTen" value="{{old("HoTen")}}" placeholder="Tên Khách Hàng" required>
                        @if($errors->has("HoTen"))
                    ...
                    <div class="form-group text-right">
                        <button type="submit" class="btn btn-danger">Thêm Khách Hàng</button>
                    </div>
                </form>
            </div>
        </div>
